...
5.  When you try to commit, the commit message and prettier, eslint checks happen. We follow [commitlint](https://github.com/conventional-changelog/commitlint/#what-is-commitlint).
